...
export const Head = () => (
  <SEO title={"Holistic Wellness for Body & Soul"} description={"Experience holistic solutions for a better life at Gaia Evolution. Our services promote spiritual growth and well-being."} canonical={CANONICAL.body} />
)