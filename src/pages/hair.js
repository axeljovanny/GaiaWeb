...
export const Head = () => (
  <SEO title={"Aveda Salon for Customized Hair Care"} description={"Discover Aveda's power at Gaia Evolution. Customized haircuts, color services, and natural, vegan products for incredible results."} canonical={CANONICAL.hair} />
)
